...
import { TCoords, TCoordsFetched, TCurrentFetched, TForecastFetched, THourlyForecastFiltered, TLocationMethod, TPollutionCurrentFetched, TPollutionForecastFetched, TWarning, TWeatherData } from './types/types';
...
function App() {
  ...
  return (
        ...
        activeDayHighlight={activeDayHighlight}
